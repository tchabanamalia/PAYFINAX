...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            // Withdraw
            Route::middleware(['checkModule:withdraw', 'checkKyc'])->group(function () {
                Route::get('withdraw/request', 'UserActionController@withdrawRequest')->name('withdraw.request');
            ...
            // DPS
            Route::middleware(['checkModule:dps', 'checkKyc'])->group(function () {
                Route::get('dps/plans', 'UserActionController@dpsPlans')->name('dps.plans');
                Route::get('dps/invest', 'UserActionController@dpsBuy')->name('dps.buy');
                Route::post('dps/invest', 'UserActionController@dpsBuyConfirm')->name('dps.buy.confirm');
                Route::get('dps/list', 'UserActionController@dpsList')->name('dps.list');
                Route::post('dps/close', 'UserActionController@dpsClose')->name('dps.close');

            });

            // FDR
            Route::middleware(['checkModule:fdr', 'checkKyc'])->group(function () {
                Route::get('/fdr/plans', 'UserActionController@fdrPlans')->name('fdr.plans');
                Route::get('/fdr/invest', 'UserActionController@fdrBuy')->name('fdr.buy');
                Route::post('/fdr/invest', 'UserActionController@fdrBuyConfirm')->name('fdr.buy.confirm');

                Route::get('/fdr/list', 'UserActionController@fdrList')->name('fdr.list');
                Route::post('/fdr/close', 'UserActionController@fdrClose')->name('fdr.close');
            });
