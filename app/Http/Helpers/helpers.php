...
function imagePath()
{
    ...
    $data['verify'] = [
        ...
        'loan'=>[
            'path'=>'assets/images/verify/loan'
        ],
        'user_kyc'=>[
            'path'=>'assets/images/verify/user_kyc'
        ]
    ];

    $data['transfer'] = [
        'beneficiary_data' => [
            'path'=>'assets/images/user/beneficiary'
        ]
    ];
...
function checkIsOtpEnable($general)
{
